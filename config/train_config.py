...
class TrainConfig:
    ...
    global_batch_size: int = 16 # global batch size must be divisible to (device_batch_size * ddp_world_size) in order to perfrom grad accumulation steps
    ...
    end_lr: float = 5e-4     # Final learning rate after cooldown
    cooldown_frac: float = 0.1  # Fraction of training for LR cooldown
    ...
    max_gen_length: int = 500     # Max tokens to generate
